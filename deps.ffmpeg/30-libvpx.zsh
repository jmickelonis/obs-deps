...
local -A urls=(
  macos https://github.com/webmproject/libvpx/archive/v1.17.0.tar.gz
  linux https://github.com/webmproject/libvpx/archive/v1.17.0.tar.gz
  windows https://github.com/webmproject/libvpx/archive/v1.17.0.tar.gz
)
local -A hashes=(
  macos "${0:a:h}/checksums/v1.17.0.tar.gz.sha256"
  linux "${0:a:h}/checksums/v1.17.0.tar.gz.sha256"
  windows "${0:a:h}/checksums/v1.17.0.tar.gz.sha256"
)
local -a patches=(
